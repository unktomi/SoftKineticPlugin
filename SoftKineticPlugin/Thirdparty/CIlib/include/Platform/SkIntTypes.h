...
#ifndef SOFTKINETIC_INTTYPES_INCLUDED
#define SOFTKINETIC_INTTYPES_INCLUDED


//vs 2010 and later versions includes <stdint.h>(declares sets of integer types having specified widths)
// note: vs 2010 stdint does not contain uchar and uint
