...
namespace DepthSense
{
    ...
    /// Returns whether the \p laser is active or not
    ///
    /// Returns whether the \p laser is active or not based on the mask returned
    /// by \c DepthSense::Depth::SampleData::getActiveLasers.
    ///
    /// \param laser the \c Laser for which the check should be done
    /// \param mask the mask returned by \c DepthSense::Depth::SampleData::getActiveLasers
    ///
    /// \return whether the \p laser is active or not
    ///
    /// \exception std::bad_alloc not enough memory to perform the requested operation
    bool
#ifndef DEPTHSENSE_DOC
        DEPTHSENSE_API
#endif
        isLaserActive (Laser laser, uint32_t mask);
    ...
    ProjectionHelper
    {
        ...
        /// Set the type of coordinate system used for the input data
        ///
        /// Set the type of coordinate system used for the input data
        ///
        ...
        ///
        /// \exception std::bad_alloc not enough memory to perform the requested operation
        void setCoordinateSystemType( DepthSense::CoordinateSystemType type);
        
        /// Return the type of coordinate system used for the input data
        ///
        /// Return the type of coordinate system used for the input data
        ///
        ...
        ///
        /// \exception std::bad_alloc not enough memory to perform the requested operation
        DepthSense::CoordinateSystemType getCoordinateSystemType() const;
    ...
    DEPTHSENSE_API
    #endif
    decompression_helper
    {
        DEPTHSENSE_PRIVATE_DECLARE(decompression_helper);
    ...
    public:
        ...
        int decompress (const int16_t* data_in, size_t size_in, int16_t* data_out, size_t size_out);

    private:
        DEPTHSENSE_DISABLE_COPY(decompression_helper);
    };
